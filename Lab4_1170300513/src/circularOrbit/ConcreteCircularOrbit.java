...
public abstract class ConcreteCircularOrbit<L,E> implements CircularOrbit<L, E> {
	...
	public void addcontactoo(E object1, E object2 , Number intimacy)
	{
		...
		checkRep();
		if(flag == 2)
			log.info("Successful addition with" + object1.toString() + " and " + object2.toString() +".");
		else
			log.warning("Add operation fail.");
	}
	...
	@Override
	abstract public void readfile(String filename) throws IOException,ReadFileFailException;
