...
public interface CentralObject 
{
	 ...
	 */
	public static CentralObject Q3creator(String choice)
	{
		if(choice.equals("Proton"))
			return new Q3_Proton();
		else if(choice.equals("Neutron"))
			return new Q3_Neutron();
		else
	 ...
	 */
	boolean equals(CentralObject obj);
